...
const Login = () => {
  ...
  return (
    <div
      className={`w-full h-screen background-img flex flex-col justify-center items-center lg:items-start sm:ml-10`}
    >
            ...
            <Form>
              ...
              <div className="flex flex-col space-y-3 mt-12">
                ...
                <div className="flex justify-center items-center space-x-2">
                  ...
                  <Link className="text-[#01B2C6]" to={"/account/register"}>
                    Register
                  </Link>
                </div>
              </div>
