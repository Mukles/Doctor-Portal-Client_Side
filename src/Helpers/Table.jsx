          ...
          <tfoot>
            <tr>
              ...
              <td
                ...
                colSpan={"3"}
              >
                <div class="btn-group ml-auto flex items-right justify-end">
                  <button class="btn btn-sm capitalize bg-[#F0F0F0] rounded-sm">
                    Privious
                  </button>
                  <button class="btn btn-active capitalize btn-sm">1</button>
                  <button class="btn bg-[#F0F0F0] capitalize btn-sm rounded-sm">
                    Next
                  </button>
                </div>
              </td>
